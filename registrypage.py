...
def register_user():
    ...
    # For simplicity, we'll just print the user's information for now.
...
logo_image = tk.PhotoImage(file="AILOGO.png")  # Replace with your logo image file path
...
register_image = tk.PhotoImage(file="NextButton.png")  # Replace with your button image file path
register_button = tk.Button(frame, image=register_image, command=register_user, relief="flat", borderwidth=0)
register_button.image = register_image  # Keep a reference to the image
register_button.pack(padx=10, pady=(5, 20))

# Define custom styling for the Entry widgets
style = ttk.Style()
